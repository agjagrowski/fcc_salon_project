...
INSERT INTO public.appointments VALUES (17, 48, 1, '10:30');
INSERT INTO public.appointments VALUES (18, 48, 2, '11am');
...
INSERT INTO public.customers VALUES (48, 'Fabio', '555-555-5555');
...
SELECT pg_catalog.setval('public.appointments_appointement_id_seq', 18, true);
...
--
-- Name: appointments fkcustomer; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fkcustomer FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);


--
-- Name: appointments fkservice; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fkservice FOREIGN KEY (service_id) REFERENCES public.services(service_id);
